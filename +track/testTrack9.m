function checkpoints = testTrack9
    ...
    checkpoints = track.add_turn_straight(checkpoints, 0, 3.4, trackWidth);
    ...
    checkpoints = track.add_turn_corner(checkpoints, -0.25, 0.7, trackWidth);
    ...
    checkpoints = track.add_turn_straight(checkpoints, 0, 0.8, trackWidth);
    checkpoints = track.add_turn_corner(checkpoints, -0.125, 0.4, trackWidth);

    checkpoints = track.add_turn_straight(checkpoints, 0, 0.8, trackWidth);
    checkpoints = track.add_turn_corner(checkpoints, 0.15, 0.5, trackWidth);
    checkpoints = track.add_turn_corner(checkpoints, -0.3, 0.5, trackWidth);
    checkpoints = track.add_turn_corner(checkpoints, 0.3, 0.5, trackWidth);
    checkpoints = track.add_turn_corner(checkpoints, -0.15, 0.5, trackWidth);
    
    checkpoints = track.add_turn_straight(checkpoints, 0, 0.7, trackWidth);
    checkpoints = track.add_turn_corner(checkpoints, -0.375, 0.5, trackWidth);
