...
cfg.scn.track_SCR_epsilon_area_tolerance = .025; % [m^2], on a 1:1 scale. will be scaled according to track creation scale
cfg.scn.track_polygons_filepath = "../results/tmp/track_polygons.mat";
